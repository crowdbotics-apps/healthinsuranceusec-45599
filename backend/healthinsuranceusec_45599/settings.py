"""
Django settings for healthinsuranceusec_45599 project.
...
ROOT_URLCONF = 'healthinsuranceusec_45599.urls'
...
WSGI_APPLICATION = 'healthinsuranceusec_45599.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthinsuranceusec_45599 API",
    "DESCRIPTION": "API documentation for healthinsuranceusec_45599 App",
    "VERSION": "v1",
}
